"""Circular Progress demo's logic: a stepped determinate value, and the
two source panels.
...
class CircularProgressDemo(ViewModel):
    """State and commands for `CircularProgress_View.yaml`."""
