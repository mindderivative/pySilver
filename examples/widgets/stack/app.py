"""Stack demo -- its own window, own process.

python examples/widgets/stack/app.py
"""

from pathlib import Path

from Stack_ViewModel import StackDemo

from pysilver import App, Settings, Theme

VIEW = Path(__file__).parent / "Stack_View.yaml"

app = App(
    VIEW,
    theme=Theme(seed="#6750A4", dark=True),
    settings=Settings(title="pySilver widgets -- Stack", width=800, height=820),
)
demo = StackDemo()
